...
const AdminDashboard = () => {
  ...
  const fetchDoctors = async () => {
    try {
      const res = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/admin/doctors`, {
        credentials: 'include',
      });
      const data = await res.json();
  ...
  const fetchPatients = async () => {
    try {
      const res = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/admin/patients`, {
        credentials: 'include',
      });
      const data = await res.json();
      setPatients(data);
  ...
  const fetchAdmins = async () => {
    try {
      const res = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/admin/admins`, {
        credentials: 'include',
      });
      const data = await res.json();
      setAdmins(data);
  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/api/admin/delete/${selectedUser.id}`,
        {
          method: 'DELETE',
          credentials: 'include',
        }
