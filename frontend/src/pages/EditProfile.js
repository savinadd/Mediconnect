...
const EditProfile = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${process.env.REACT_APP_BACKEND_URL}/api/user/profile`, {
      ...
      .then(res => res.json())
      .then(data => {
        const isoDate = data.birth_date ? new Date(data.birth_date).toISOString().slice(0, 10) : '';
    ...
    <div className="edit-profile-container">
      ...
      <form className="edit-profile-form" onSubmit={handleSubmit}>
        <div className="form-section">
          ...
          <input name="last_name" value={profileData.last_name} onChange={handleChange} required />
          ...
          <input name="address" value={profileData.address} onChange={handleChange} required />
        </div>
        ...
        {role === 'patient' && (
          <div className="form-section">
            ...
            <input name="height" value={profileData.height} onChange={handleChange} required />

            <label>Weight (kg) *</label>
            <input name="weight" value={profileData.weight} onChange={handleChange} required />
